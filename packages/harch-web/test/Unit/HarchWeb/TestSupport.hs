...
sampleApplicationWithConfig staticAssetsConfig requestPolicyConfig =
  Application
    { appName = "sample",
      ...
      applicationRequestIdIngress = freshRequestIdIngress,
      applicationNavigationRuntime = Nothing,
      applicationRuntimeAssets = [],
      ...
      applicationClientActionFailureRoute = Nothing,
      routeExecutionPolicy = const unboundedRouteExecutionPolicy,
      routeExecutionIdentity = routeExecutionIdentityFromMetadata . testEndpointMetadata,
      renderRequestResponse = \_ _ -> pure . renderSampleResponse,
      decodeClientAction = DecodedClientAction . clientActionPath,
      csrfProtection = testCsrfProtection,
      clientActionCsrfRequirement = \_ _ -> ClientActionCsrfRequired,
...
rootPathApplication =
  Application
    { appName = "root-path",
      ...
      routeExecutionPolicy = const unboundedRouteExecutionPolicy,
      routeExecutionIdentity = routeExecutionIdentityFromMetadata . testEndpointMetadata,
      renderRequestResponse = \_ _ request -> pure (PageResponse testPageSecurity (samplePage request)),
      decodeClientAction = DecodedClientAction . clientActionPath,
      csrfProtection = testCsrfProtection,
      clientActionCsrfRequirement = \_ _ -> ClientActionCsrfRequired,
      handleClientAction = const (pure Nothing),
