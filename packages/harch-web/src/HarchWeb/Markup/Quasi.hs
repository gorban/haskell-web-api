...
lowerNode node =
  case node of
    ...
    ComponentNode position componentName attributes children -> lowerComponentNode position componentName attributes children
...
lowerNamedComponentProperty attribute =
  case attribute of
    LiteralAttribute position attributeName literal -> pure (attributeName, (position, textLiteral literal))
