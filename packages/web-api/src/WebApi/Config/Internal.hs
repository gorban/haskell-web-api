...
parseRequestHeadLimitsP =
  RequestHeadLimits
    ...
    <*> parseOptionalRequestItemCountLimitP "REQUEST_COOKIE_MAX_COUNT"
    <*> parseOptionalRequestByteLimitP "REQUEST_COOKIE_NAME_MAX_BYTES"
    <*> parseOptionalRequestByteLimitP "REQUEST_COOKIE_VALUE_MAX_BYTES"
