...
| Observability | Request policy, opaque `RequestId` ingress, telemetry-safe route observation, configured OTLP trace export, and logging seams. | Collector credentials, retention, dashboards, alerting, and any durable business/security history. |
